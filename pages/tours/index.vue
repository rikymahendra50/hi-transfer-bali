    ...
    <UIContainer>
      <div class="flex flex-col space-y-6 mt-4">
        <div class="flex justify-between items-center">
          <div>Menampilkan 7 paket tur</div>
          <div>
        ...
        <div>
          <div
            ...
            v-if="dataExample.length > 0"
          >
            <TourCard v-for="n in dataExample" :key="n.id" :tour="n" />
          </div>

          <Empty
            v-else
            description="Maaf, kami tidak dapat menemukan paket tur yang tersedia pada jadwal yang kamu inginkan. <br class='hidden md:block' /> Coba pilih tanggal yang lain."
          />
        </div>
      </div>
    </UIContainer>
