    ...
    <UIContainer>
      ...
      >
        <div class="flex flex-col space-y-2">
          ...
          <div>
            <div class="text-zinc-400 text-xs">Harga Mulai Dari</div>
        ...
        <div class="flex justify-end w-full">
          <div>
            <button class="btn btn-primary">
              Booking Sekarang
              <Icon name="i-heroicons-arrow-right" class="w-5 h-5 -rotate-45" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-4">
        ...
        <div>
          ...
          commodi nihil provident? Blanditiis ab corporis cum fugit repudiandae
          reiciendis quam accusantium. Officia quam facilis ducimus veniam ut
          autem dolores fuga!
        </div>
      </div>
    </UIContainer>
