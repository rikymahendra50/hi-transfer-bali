                    ...
                    <div class="w-full">
                        <div
                            ...
                            <div class="text-center">
                                Bandara Int'l I Gusti Ngurah Rai
                            </div>
                        ...
                        <div class="text-zinc-400 text-sm whitespace-nowrap text-center lg:text-left ">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-6 divide-x-2">
                <div class="space-y-6 py-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="divider text-xs text-zinc-400">Perjalananmu sekitar 10,9km</div>
                        <VehicleAddressInformation />
                    </div>
