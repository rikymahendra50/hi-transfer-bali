<template>
  <!-- <div class="space-y-4 border rounded-xl p-4 divide-y">
    <div class="grid grid-cols-[100px_1fr] space-x-2">
      <div class="rounded-xl overflow-hidden w-[100px] h-[100px]">
  ...
  <div class="space-y-4 border rounded-xl p-4 divide-y">
    ...
    <div class="">
      <div class="font-semibold pt-2 pb-4">{{ $t("detail-harga") }}</div>
      <div
