<template>
    <div class="p-4 relative">
        ...
        <div class="relative rounded-xl overflow-hidden">
            <div
                ...
                <Transition
                    ...
                    name="fade"
                >
                    <h1 class="text-3xl lg:text-5xl text-white font-bold  max-w-4xl mx-auto">
                        {{ currentSlide?.title }}
                    </h1>
                </Transition>
                <Transition
        ...
        <div class="lg:absolute z-10  w-full inset-x-0 bottom-0 lg:-bottom-4 ">
            ...
            <div>
                <div class="max-w-5xl bg-white  mx-auto mt-auto bottom-0 p-6 lg:p-2 shadow rounded-lg">
